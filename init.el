...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (setq theming-modifications
        '((darktooth
           ;; Font locking
           (font-lock-function-name-face :bold t :foreground "#F7C508")
           )
          (leuven
